...
final class _MemoryStatisticDatasource implements IStatisticDatasource {
  _MemoryStatisticDatasource([
    this.value = const GameStatistic(wins: 0, loses: 0, streak: 0, maxStreak: 0, attempts: GameStatistic.zeroAttempts),
  ]);
