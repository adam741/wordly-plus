...
final class _LevelRepository implements ILevelRepository {
  _LevelRepository({this.progress = const GameResult(secretWord: 'apple', lvlNumber: 1)});

  final GameResult progress;
...
final class _StatisticsRepository implements IStatisticsRepository {
  const _StatisticsRepository();
