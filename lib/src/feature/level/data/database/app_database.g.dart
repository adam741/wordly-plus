...
class $LevelResultsTable extends LevelResults with TableInfo<$LevelResultsTable, LevelResultRow> {
  @override
  ...
  static const VerificationMeta _dictionaryCodeMeta = const VerificationMeta('dictionaryCode');
  @override
  ...
  static const VerificationMeta _secretWordMeta = const VerificationMeta('secretWord');
  @override
  ...
  late final GeneratedColumn<bool> isWin = GeneratedColumn<bool>(
    ...
    requiredDuringInsert: false,
    defaultConstraints: GeneratedColumn.constraintIsAlways('CHECK ("is_win" IN (0, 1))'),
  );

  @override
  List<GeneratedColumn> get $columns => [dictionaryCode, levelNumber, secretWord, isWin];
  ...
  @override
  VerificationContext validateIntegrity(Insertable<LevelResultRow> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('dictionary_code')) {
      context.handle(
        _dictionaryCodeMeta,
        dictionaryCode.isAcceptableOrUnknown(data['dictionary_code']!, _dictionaryCodeMeta),
      );
    } else if (isInserting) {
      context.missing(_dictionaryCodeMeta);
    }
    if (data.containsKey('level_number')) {
      context.handle(_levelNumberMeta, levelNumber.isAcceptableOrUnknown(data['level_number']!, _levelNumberMeta));
    } else if (isInserting) {
      context.missing(_levelNumberMeta);
    }
    if (data.containsKey('secret_word')) {
      context.handle(_secretWordMeta, secretWord.isAcceptableOrUnknown(data['secret_word']!, _secretWordMeta));
    }
    if (data.containsKey('is_win')) {
      context.handle(_isWinMeta, isWin.isAcceptableOrUnknown(data['is_win']!, _isWinMeta));
    }
    return context;
  }
  ...
  LevelResultRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LevelResultRow(
      ...
      levelNumber: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}level_number'])!,
      secretWord: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}secret_word']),
      isWin: attachedDatabase.typeMapping.read(DriftSqlType.bool, data['${effectivePrefix}is_win']),
    );
  }
...
class LevelResultRow extends DataClass implements Insertable<LevelResultRow> {
  ...
  const LevelResultRow({required this.dictionaryCode, required this.levelNumber, this.secretWord, this.isWin});
  ...
  LevelResultsCompanion toCompanion(bool nullToAbsent) {
    return LevelResultsCompanion(
      ...
      secretWord: secretWord == null && nullToAbsent ? const Value.absent() : Value(secretWord),
      isWin: isWin == null && nullToAbsent ? const Value.absent() : Value(isWin),
    );
  }

  factory LevelResultRow.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
  ...
  LevelResultRow copyWithCompanion(LevelResultsCompanion data) {
    return LevelResultRow(
      dictionaryCode: data.dictionaryCode.present ? data.dictionaryCode.value : this.dictionaryCode,
      levelNumber: data.levelNumber.present ? data.levelNumber.value : this.levelNumber,
      secretWord: data.secretWord.present ? data.secretWord.value : this.secretWord,
  ...
  @override
  int get hashCode => Object.hash(dictionaryCode, levelNumber, secretWord, isWin);
...
class $LevelProgressEntriesTable extends LevelProgressEntries
  ...
  static const VerificationMeta _boardJsonMeta = const VerificationMeta('boardJson');
  @override
  ...
  @override
  List<GeneratedColumn> get $columns => [dictionaryCode, levelNumber, secretWord, boardJson];
  ...
  VerificationContext validateIntegrity(Insertable<LevelProgressRow> instance, {bool isInserting = false}) {
    ...
    if (data.containsKey('board_json')) {
      context.handle(_boardJsonMeta, boardJson.isAcceptableOrUnknown(data['board_json']!, _boardJsonMeta));
    } else if (isInserting) {
  ...
  LevelProgressRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LevelProgressRow(
      ...
      levelNumber: attachedDatabase.typeMapping.read(DriftSqlType.int, data['${effectivePrefix}level_number'])!,
      secretWord: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}secret_word'])!,
      boardJson: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}board_json'])!,
    );
  }
...
class LevelProgressRow extends DataClass implements Insertable<LevelProgressRow> {
  ...
  LevelProgressRow copyWith({String? dictionaryCode, int? levelNumber, String? secretWord, String? boardJson}) =>
      LevelProgressRow(
        dictionaryCode: dictionaryCode ?? this.dictionaryCode,
        levelNumber: levelNumber ?? this.levelNumber,
        secretWord: secretWord ?? this.secretWord,
  ...
  @override
  int get hashCode => Object.hash(dictionaryCode, levelNumber, secretWord, boardJson);
...
class $MigrationMarkersTable extends MigrationMarkers with TableInfo<$MigrationMarkersTable, MigrationMarkerRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  static const VerificationMeta _migrationKeyMeta = const VerificationMeta('migrationKey');
  @override
  ...
  @override
  VerificationContext validateIntegrity(Insertable<MigrationMarkerRow> instance, {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('migration_key')) {
      context.handle(_migrationKeyMeta, migrationKey.isAcceptableOrUnknown(data['migration_key']!, _migrationKeyMeta));
    } else if (isInserting) {
  ...
  MigrationMarkerRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return MigrationMarkerRow(
      migrationKey: attachedDatabase.typeMapping.read(DriftSqlType.string, data['${effectivePrefix}migration_key'])!,
...
class MigrationMarkerRow extends DataClass implements Insertable<MigrationMarkerRow> {
  ...
  MigrationMarkersCompanion toCompanion(bool nullToAbsent) {
    return MigrationMarkersCompanion(migrationKey: Value(migrationKey), version: Value(version));
  }

  factory MigrationMarkerRow.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
    return MigrationMarkerRow(
  ...
  MigrationMarkerRow copyWith({String? migrationKey, int? version}) =>
      MigrationMarkerRow(migrationKey: migrationKey ?? this.migrationKey, version: version ?? this.version);

  MigrationMarkerRow copyWithCompanion(MigrationMarkersCompanion data) {
    return MigrationMarkerRow(
      migrationKey: data.migrationKey.present ? data.migrationKey.value : this.migrationKey,
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is MigrationMarkerRow && other.migrationKey == this.migrationKey && other.version == this.version);
}
...
class MigrationMarkersCompanion extends UpdateCompanion<MigrationMarkerRow> {
  ...
  MigrationMarkersCompanion copyWith({Value<String>? migrationKey, Value<int>? version, Value<int>? rowid}) {
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $LevelProgressEntriesTable levelProgressEntries = $LevelProgressEntriesTable(this);
  late final $MigrationMarkersTable migrationMarkers = $MigrationMarkersTable(this);

  @override
  Iterable<TableInfo<Table, Object?>> get allTables => allSchemaEntities.whereType<TableInfo<Table, Object?>>();

  @override
  List<DatabaseSchemaEntity> get allSchemaEntities => [levelResults, levelProgressEntries, migrationMarkers];
}
...
class $$LevelResultsTableFilterComposer extends Composer<_$AppDatabase, $LevelResultsTable> {
  ...
  ColumnFilters<String> get dictionaryCode =>
      $composableBuilder(column: $table.dictionaryCode, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get levelNumber =>
      $composableBuilder(column: $table.levelNumber, builder: (column) => ColumnFilters(column));

  ColumnFilters<String> get secretWord =>
      $composableBuilder(column: $table.secretWord, builder: (column) => ColumnFilters(column));

  ColumnFilters<bool> get isWin => $composableBuilder(column: $table.isWin, builder: (column) => ColumnFilters(column));
}

class $$LevelResultsTableOrderingComposer extends Composer<_$AppDatabase, $LevelResultsTable> {
  ...
  ColumnOrderings<String> get dictionaryCode =>
      $composableBuilder(column: $table.dictionaryCode, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get levelNumber =>
      $composableBuilder(column: $table.levelNumber, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<String> get secretWord =>
      $composableBuilder(column: $table.secretWord, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<bool> get isWin =>
      $composableBuilder(column: $table.isWin, builder: (column) => ColumnOrderings(column));
}

class $$LevelResultsTableAnnotationComposer extends Composer<_$AppDatabase, $LevelResultsTable> {
  ...
  GeneratedColumn<String> get dictionaryCode =>
      $composableBuilder(column: $table.dictionaryCode, builder: (column) => column);

  GeneratedColumn<int> get levelNumber => $composableBuilder(column: $table.levelNumber, builder: (column) => column);

  GeneratedColumn<String> get secretWord => $composableBuilder(column: $table.secretWord, builder: (column) => column);

  GeneratedColumn<bool> get isWin => $composableBuilder(column: $table.isWin, builder: (column) => column);
}
...
class $$LevelResultsTableTableManager
    extends
        RootTableManager<
          ...
          (LevelResultRow, BaseReferences<_$AppDatabase, $LevelResultsTable, LevelResultRow>),
          LevelResultRow,
  ...
  $$LevelResultsTableTableManager(_$AppDatabase db, $LevelResultsTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$LevelResultsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$LevelResultsTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$LevelResultsTableAnnotationComposer($db: db, $table: table),
...
class $$LevelProgressEntriesTableFilterComposer extends Composer<_$AppDatabase, $LevelProgressEntriesTable> {
  ...
  ColumnFilters<String> get boardJson =>
      $composableBuilder(column: $table.boardJson, builder: (column) => ColumnFilters(column));
}

class $$LevelProgressEntriesTableOrderingComposer extends Composer<_$AppDatabase, $LevelProgressEntriesTable> {
  ...
  ColumnOrderings<String> get boardJson =>
      $composableBuilder(column: $table.boardJson, builder: (column) => ColumnOrderings(column));
}

class $$LevelProgressEntriesTableAnnotationComposer extends Composer<_$AppDatabase, $LevelProgressEntriesTable> {
  ...
  GeneratedColumn<String> get boardJson => $composableBuilder(column: $table.boardJson, builder: (column) => column);
}
...
class $$LevelProgressEntriesTableTableManager
    extends
        RootTableManager<
          ...
          (LevelProgressRow, BaseReferences<_$AppDatabase, $LevelProgressEntriesTable, LevelProgressRow>),
          LevelProgressRow,
          PrefetchHooks Function()
        > {
  $$LevelProgressEntriesTableTableManager(_$AppDatabase db, $LevelProgressEntriesTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$LevelProgressEntriesTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$LevelProgressEntriesTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$LevelProgressEntriesTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> dictionaryCode = const Value.absent(),
                Value<int> levelNumber = const Value.absent(),
...
typedef $$MigrationMarkersTableCreateCompanionBuilder =
    MigrationMarkersCompanion Function({required String migrationKey, required int version, Value<int> rowid});
typedef $$MigrationMarkersTableUpdateCompanionBuilder =
    MigrationMarkersCompanion Function({Value<String> migrationKey, Value<int> version, Value<int> rowid});

class $$MigrationMarkersTableFilterComposer extends Composer<_$AppDatabase, $MigrationMarkersTable> {
  ...
  ColumnFilters<String> get migrationKey =>
      $composableBuilder(column: $table.migrationKey, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get version =>
      $composableBuilder(column: $table.version, builder: (column) => ColumnFilters(column));
}

class $$MigrationMarkersTableOrderingComposer extends Composer<_$AppDatabase, $MigrationMarkersTable> {
  ...
  ColumnOrderings<String> get migrationKey =>
      $composableBuilder(column: $table.migrationKey, builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get version =>
      $composableBuilder(column: $table.version, builder: (column) => ColumnOrderings(column));
}

class $$MigrationMarkersTableAnnotationComposer extends Composer<_$AppDatabase, $MigrationMarkersTable> {
  ...
  GeneratedColumn<String> get migrationKey =>
      $composableBuilder(column: $table.migrationKey, builder: (column) => column);
...
class $$MigrationMarkersTableTableManager
    extends
        RootTableManager<
          ...
          (MigrationMarkerRow, BaseReferences<_$AppDatabase, $MigrationMarkersTable, MigrationMarkerRow>),
          MigrationMarkerRow,
          PrefetchHooks Function()
        > {
  $$MigrationMarkersTableTableManager(_$AppDatabase db, $MigrationMarkersTable table)
    : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () => $$MigrationMarkersTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () => $$MigrationMarkersTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () => $$MigrationMarkersTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback:
              ({
                Value<String> migrationKey = const Value.absent(),
                Value<int> version = const Value.absent(),
                Value<int> rowid = const Value.absent(),
              }) => MigrationMarkersCompanion(migrationKey: migrationKey, version: version, rowid: rowid),
          createCompanionCallback:
              ({required String migrationKey, required int version, Value<int> rowid = const Value.absent()}) =>
                  MigrationMarkersCompanion.insert(migrationKey: migrationKey, version: version, rowid: rowid),
          withReferenceMapper: (p0) => p0.map((e) => (e.readTable(table), BaseReferences(db, table, e))).toList(),
          prefetchHooksCallback: null,
        ),
      );
...
class $AppDatabaseManager {
  ...
  $$LevelResultsTableTableManager get levelResults => $$LevelResultsTableTableManager(_db, _db.levelResults);
