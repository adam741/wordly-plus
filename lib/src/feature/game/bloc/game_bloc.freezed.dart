...
TResult map<TResult extends Object?>(
    {required TResult Function( _GameChangeDictionary value) changeDictionary, required TResult Function( _GameChangeGameMode value) changeGameMode, required TResult Function( _GameResetBoard value) resetBoard, required TResult Function( _GameLetterPressed value) letterPressed, required TResult Function( _GameDeletePressed value) deletePressed, required TResult Function( _GameDeleteLongPressed value) deleteLongPressed, required TResult Function( _GameEnterPressed value) enterPressed, required TResult Function( _GameRetryLevelPersistence value) retryLevelPersistence, required TResult Function( _GameListenKeyEvent value) listenKeyEvent,}) {
  final _that = this;
  switch (_that) {
    case _GameChangeDictionary():
      return changeDictionary(_that);
    case _GameChangeGameMode():
      return changeGameMode(_that);
    case _GameResetBoard():
      return resetBoard(_that);
    case _GameLetterPressed():
      return letterPressed(_that);
    case _GameDeletePressed():
      return deletePressed(_that);
    case _GameDeleteLongPressed():
      return deleteLongPressed(_that);
    case _GameEnterPressed():
      return enterPressed(_that);
    case _GameRetryLevelPersistence():
      return retryLevelPersistence(_that);
    case _GameListenKeyEvent():
...
TResult? mapOrNull<TResult extends Object?>(
    {TResult? Function( _GameChangeDictionary value)? changeDictionary, TResult? Function( _GameChangeGameMode value)? changeGameMode, TResult? Function( _GameResetBoard value)? resetBoard, TResult? Function( _GameLetterPressed value)? letterPressed, TResult? Function( _GameDeletePressed value)? deletePressed, TResult? Function( _GameDeleteLongPressed value)? deleteLongPressed, TResult? Function( _GameEnterPressed value)? enterPressed, TResult? Function( _GameRetryLevelPersistence value)? retryLevelPersistence, TResult? Function( _GameListenKeyEvent value)? listenKeyEvent,}) {
  final _that = this;
  switch (_that) {
    case _GameChangeDictionary() when changeDictionary != null:
      return changeDictionary(_that);
    case _GameChangeGameMode() when changeGameMode != null:
      return changeGameMode(_that);
    case _GameResetBoard() when resetBoard != null:
      return resetBoard(_that);
    case _GameLetterPressed() when letterPressed != null:
      return letterPressed(_that);
    case _GameDeletePressed() when deletePressed != null:
      return deletePressed(_that);
    case _GameDeleteLongPressed() when deleteLongPressed != null:
      return deleteLongPressed(_that);
    case _GameEnterPressed() when enterPressed != null:
      return enterPressed(_that);
    case _GameRetryLevelPersistence() when retryLevelPersistence != null:
      return retryLevelPersistence(_that);
    case _GameListenKeyEvent() when listenKeyEvent != null:
      return listenKeyEvent(_that);
    case _:
      return null;
  }
...
@optionalTypeArgs
TResult map<TResult extends Object?>(
    {required TResult Function( GameIdle value) idle, required TResult Function( GameLoss value) loss, required TResult Function( GameWin value) win, required TResult Function( GameFailure value) failure, required TResult Function( GamePersistenceFailure value) persistenceFailure,}) {
  final _that = this;
  switch (_that) {
    case GameIdle():
      return idle(_that);
...
@optionalTypeArgs
TResult? mapOrNull<TResult extends Object?>(
    {TResult? Function( GameIdle value)? idle, TResult? Function( GameLoss value)? loss, TResult? Function( GameWin value)? win, TResult? Function( GameFailure value)? failure, TResult? Function( GamePersistenceFailure value)? persistenceFailure,}) {
  final _that = this;
  switch (_that) {
    case GameIdle() when idle != null:
      return idle(_that);
    case GameLoss() when loss != null:
      return loss(_that);
    case GameWin() when win != null:
      return win(_that);
    case GameFailure() when failure != null:
      return failure(_that);
    case GamePersistenceFailure() when persistenceFailure != null:
      return persistenceFailure(_that);
    case _:
      return null;
  }
...
class GamePersistenceFailure extends GameState {
  const GamePersistenceFailure(
      {required this.dictionary, required this.secretWord, required this.gameMode, required this.gameCompleted, required final List<
          LetterInfo> board, required final Map<String,
          LetterStatus> statuses, required this.lvlNumber, required this.operation, required this.pendingProgress, required this.completedLevel, required this.pendingIsWin, required this.retryCount})
      : _board = board,
        _statuses = statuses,
        super._();
  ...
  bool operator ==(Object other) {
    return identical(this, other) || (other.runtimeType == runtimeType && other is GamePersistenceFailure &&
        ...
        (identical(other.pendingProgress, pendingProgress) || other.pendingProgress == pendingProgress) &&
        (identical(other.completedLevel, completedLevel) || other.completedLevel == completedLevel) &&
        (identical(other.pendingIsWin, pendingIsWin) || other.pendingIsWin == pendingIsWin) &&
        (identical(other.retryCount, retryCount) || other.retryCount == retryCount));
  }
